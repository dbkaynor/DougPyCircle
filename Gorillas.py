...
def makeCityScape():
    ...
    being chosen. The slope also determines the height of the first building, which is stored in newHeight."""
    ...
    gHeight = 25 # (I'm not sure what this supposed to be in the original Qbasic code, but I copied it anyway)
